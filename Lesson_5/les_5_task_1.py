...
while True:
    try:
        c_number = int(input('Введите количество компаний: '))
    except ValueError:
...
mid_profit = all_profit / c_number
...
print(f'Прибыль ниже среднего у {len(not_prof_c)} компаний:')

for name in not_prof_c:
    print(name)
